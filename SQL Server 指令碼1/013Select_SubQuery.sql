...
--查詢劉天王這位員工處理過的所有訂單資料(合併查詢inner join)
select * from 訂貨主檔 as o inner join 員工 as e
on o.員工編號=e.員工編號  
where e.姓名='劉天王'

--查詢大華城台北這位客戶的訂單資料(合併查詢inner join)
select o.* 
...
--合併查詢的寫法
--自我合併：一定要取別名，而且不可以重複取名

--77*77-77(重複的)=5852筆資料
